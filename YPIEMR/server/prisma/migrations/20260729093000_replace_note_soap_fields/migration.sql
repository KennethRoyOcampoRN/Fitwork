...
INSERT INTO "new_ClinicalNote" ("assessment", "authorId", "chiefComplaint", "createdAt", "disposition", "editableUntil", "employeeId", "followUpDate", "id", "isWorkRelated", "legacyAuthorName", "noteType", "plan", "referredTo", "sourceType", "status", "updatedAt", "visitCategory", "visitDateTime", "voidReason", "voidedAt", "voidedById") SELECT "assessment", "authorId", "chiefComplaint", "createdAt", "disposition", "editableUntil", "employeeId", "followUpDate", "id", "isWorkRelated", "legacyAuthorName", "noteType", "plan", "referredTo", "sourceType", "status", "updatedAt", "visitCategory", "visitDateTime", "voidReason", "voidedAt", "voidedById" FROM "ClinicalNote";
